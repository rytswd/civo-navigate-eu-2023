...
When using KinD clusters, do note how the cluster names get prefix of =kind-=. This does not match with the rest of the steps in this document. You can either change the name of the cluster for each step when copy/pasting the commands, or you can change the context name using tools such as ~kubectx~.
...
- /tmp/civo-navigate-mco-demo/kind-config/cluster-1-v1.26.yaml
- /tmp/civo-navigate-mco-demo/kind-config/cluster-2-v1.26.yaml
- /tmp/civo-navigate-mco-demo/kind-config/cluster-3-v1.26.yaml
...
#+begin_src bash
  ...
  kind create cluster \
       --name cluster-1 \
       --config ./tools/kind-config/cluster-1-v1.26.yaml
  kind create cluster \
       --name cluster-2 \
       --config ./tools/kind-config/cluster-2-v1.26.yaml
  kind create cluster \
       --name cluster-3 \
       --config ./tools/kind-config/cluster-3-v1.26.yaml
#+end_src
